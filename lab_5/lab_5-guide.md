...
In a few moments we'll launch a PyTorch test in our K8s cluster. Immediately after the containers deploy PyTorch will initialize. Then before NCCL/Gloo starts communicating, the SRv6 PyTorch plugin will:
...
<img src="../topo_drawings/lab5-edgeshark-capture-xrd01-gi3.png" width="800" />
