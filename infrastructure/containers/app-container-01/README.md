# Containerlab Ubuntu Utility Node: app-container-01 (.108) – Dockerfile + Entrypoint Overview
...
This file corresponds to the **app-container-01** utility node.
...
```
docker build -t cl-app-container-01:latest .
```
