...
echo "--- Applying Network Configuration for app-container-01 (.108) ---"
...
# --- 3. eth1: Configuration (app-container-01 Data Plane) ---
if ip link show eth1 > /dev/null 2>&1; then
    ...
    # IPv4 Routes via app-container-01 Gateway (10.101.1.1)
...
if ip link show eth2 > /dev/null 2>&1; then
    ...
    # Current topology doesn't specify app-container-01 eth2 IPs,
